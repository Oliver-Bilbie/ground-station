...
A demo video if available [here](https://oliver-bilbie-assets.s3.eu-west-1.amazonaws.com/ground-station-demo.webm) which shows a ground station on the left, and three satellites on the right.
