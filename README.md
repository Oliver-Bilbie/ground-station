...
You can view an instance of the project running on AWS [here](https://ground-station.oliver-bilbie.co.uk/), where satellites will randomly spin up and tear down over time. See the [server directory](server) for implementation details.
